...
QT_MOC_LITERAL(3, 20, 11), // "messageSent"
QT_MOC_LITERAL(4, 32, 12), // "server_start"
QT_MOC_LITERAL(5, 45, 5), // "print"
QT_MOC_LITERAL(6, 51, 13), // "newConnection"
QT_MOC_LITERAL(7, 65, 8) // "read_msg"

    },
    "Display\0newMessage\0\0messageSent\0"
    "server_start\0print\0newConnection\0"
    "read_msg"
};
...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->server_start(); break;
        case 3: _t->print((*reinterpret_cast< QDateTime(*)>(_a[1]))); break;
        case 4: _t->newConnection(); break;
        case 5: _t->read_msg(); break;
        default: ;
        }
        ...
        {
            typedef void (Display::*_t)(QDateTime );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Display::newMessage)) {
                *result = 0;
            }
        }
        {
            typedef void (Display::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Display::messageSent)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Display::newMessage(QDateTime _t1)
{
